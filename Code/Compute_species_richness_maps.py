...
1) Matrix richness for three groups:
   - all mammals
   ...
   To generate matrix richness maps:
     ...
     - Save the output as, for example: "species_richness_matrix_all.tif".
...
maps and IUCN range data, as described in the Materials and Methods section of the paper.
...
if __name__ == "__main__":
    ...
    Adjust the paths below according to:
        ...
        - whether you are generating richness for matrix areas
    ...
    # Examples:
    #   Matrix richness: ".../matrix_all_species_tifs/"
    #   Suitable richness: ".../suitable_all_species_tifs/"
    ...
    #   "species_richness_matrix_declining.tif"
    #   "species_richness_matrix_threatened.tif"
    #   "species_richness_suitable_all.tif"
     output_filename = "species_richness_matrix_all.tif"
