...
These rasters represent species richness within species-rich matrix areas for each species group analyzed in the manuscript (all mammals, mammals with declining population trends, and mammals with threatened status). They provide the required inputs for reproducing all hotspot analyses.
